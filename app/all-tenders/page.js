...
export default function AllTenders() {
  ...
  const branches = ["All Branches", ...new Set(tenders.map((t) => t.branch))];
  const categories = [
    "All Categories",
    ...new Set(tenders.map((t) => t.category)),
  ];
  ...
  return (
    <main className="all-tenders-page">
      <div className="page-header">
        <div>
          <div className="breadcrumb">Home / Tenders / All Tenders</div>
          <h1>All Tenders</h1>
          <p>View and manage all tender opportunities.</p>
        </div>

        <button className="new-tender-button">
          + New Tender
        </button>
      </div>
      ...
      <section className="summary-grid">
        ...
        <div className="summary-card">
          <span>Submitted</span>
          <strong>
            {filteredTenders.filter((t) => t.status === "Submitted").length}
          </strong>
        ...
        <div className="summary-card">
          ...
          <strong>
            {filteredTenders.filter((t) => t.status === "In Process").length}
          </strong>
      ...
      <section className="table-card">
        <div className="table-header">
          <div>
            <h2>Tender List</h2>
            <p>{filteredTenders.length} records found</p>
          </div>
        </div>
